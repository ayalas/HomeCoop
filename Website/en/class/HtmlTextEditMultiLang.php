...
class HtmlTextEditMultiLang {
  ...
  public function EchoHtml()
  {
    ...
    if ( is_array($g_aSupportedLanguages) && count($g_aSupportedLanguages) > 0 )
    {
      ...
      if ($this->m_aData[self::PROPERTY_REQUIRED])
        echo ' class="required" ';
      echo 'for="' , $sID , '">' , $this->m_aData[self::PROPERTY_LABEL] , '‏:‏</label></td>';
    ...
    else
    {
      ...
      if ($this->m_aData[self::PROPERTY_REQUIRED])
        echo ' class="required" ';
      echo 'for="' , $this->m_aData[self::PROPERTY_ID] , '">' , $sLabel , '‏:‏</label></td>';
  ...
  public static function EchoHelpText($sHelpText)
  {
    ...
    echo '><a class="tooltiphelp" href="#" >‏?‏<span>' , $sHelpText,
      '</span></a></td>';
