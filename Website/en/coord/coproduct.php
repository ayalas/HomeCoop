  ...
  <?php
    ...
    { ?> 
      ...
      if (ctlDisabled.options[ctlDisabled.selectedIndex].value == 1) {
        sMessage = "<?php echo sprintf('This operation will delete as well all the orders that may have been made for this product. Please confirm', $oRecord->TotalCoopOrder); ?>";
        if (!confirm(decodeXml(sMessage)))
          return;
      }
    <?php } ?>
