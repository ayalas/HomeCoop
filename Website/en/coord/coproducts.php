    ...
    <tr>
        <td >
            ...
            <tr>
              ...
              <td class="columntitlenowidth" ><a id="burdenhlp" name="burdenhlp" class="tooltip" href="#burdenhlp" >Burden<span>An index that indicates how much this product &quot;burdens&quot; a delivery. Helps to uphold a cooperative order&#x27;s Delivery Capacity, if set</span></a></td>
            </tr>
            <?php
                if (!$recTable)
                {
                ...
                {//PackageSize
                  while ( $recTable )
                  {
                      ...
                      {
                        $sTooltipLines .= sprintf("<div>%s: %s items</div>", "Max. Member Order", $recTable["fMaxUserOrder"]);
                        $bTooltip = TRUE;
                      }
                      if ($recTable["fMaxCoopOrder"] != NULL)
                      {
                        $sTooltipLines .= sprintf("<div>%s: %s items</div>", "Max. Coop Order", $recTable["fMaxCoopOrder"]);
                        $bTooltip = TRUE;
                      }
