...
$sPageTitle = 'Copy a New Cooperative Order';
        ...
        <td >
            <table cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                  ...
                  <?php if ($g_oError->HadError) echo ' disabled="disabled" '; ?>>Save</button>&nbsp;
                  <?php
                    echo '<a href="cooporder.php?id=', $oRecord->SourceCoopOrderID,'" >', sprintf('Back to %s', $oRecord->Name),
                      '</a>';
                  ?>
                  </td>
                </tr>
                ...
                <tr>
                  <?php 
                    ...
                    $selStatus = new HtmlSelectArray('Status', 'Status', $aArr, CoopOrder::STATUS_DRAFT);
