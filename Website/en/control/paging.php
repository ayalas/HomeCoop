...
function WritePaging() {
  ...
  if ($nPage <= 0 || $nPage > 1) {
    //back to first page
    echo '<a href="', $sLinkBase, '1', '" title="First page" ><img src="',
        $g_sRootRelativePath,
    ...
    if ($nPage > 1 || $bHasNextPage) {
      echo '<a href="', $sLinkBase, ($nPage -1), '" title="Previous page" ><img src="',
        $g_sRootRelativePath,
  ...
  if ($g_sPageNumber != 'last' && $bHasNextPage) {
    //forward one page
    echo '<a href="', $sLinkBase, ($nPage+1), '" title="Next page" ><img src="',
        $g_sRootRelativePath,
        'img/arrow-', $sForwardDir, '.png" border="0" /></a>';
    
    //forward to last page
    echo '<a href="', $sLinkBase, 'last', '" title="Last page" ><img src="',
      $g_sRootRelativePath,
