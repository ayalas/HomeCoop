...
<span class="facettitle">Producers</span>
...
<div id="divFacetFilter"><button type="button" id="btnFilter" disabled="disabled" class="facetapply" onclick="JavaScript:ApplyFacetFilter();">Apply filter</button></div>
</div>
