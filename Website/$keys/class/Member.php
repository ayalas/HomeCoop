...
class Member extends SQLBase  {
 ...
 public function HasAccessToRoles()
 {
  ...
  public function Validate()
  {
    ...
    {
      $g_oError->AddError(sprintf('<!$FIELD_INVALID$!>', '<!$FIELD_EMAIL2$!>'));
      $bValid = FALSE;
    }
    ...
    {
      $g_oError->AddError(sprintf('<!$FIELD_INVALID$!>', '<!$FIELD_EMAIL3$!>'));
      $bValid = FALSE;
    }
    ...
    {
      $g_oError->AddError(sprintf('<!$FIELD_INVALID$!>', '<!$FIELD_EMAIL4$!>'));
      $bValid = FALSE;
    }
