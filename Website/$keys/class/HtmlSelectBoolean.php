...
class HtmlSelectBoolean {
  ...
  {
    echo '<td nowrap><label class="required" for="' , $this->m_aData[self::PROPERTY_ID] , '" >' , 
            $this->m_aData[self::PROPERTY_LABEL] , '<!$FIELD_DISPLAY_NAME_SUFFIX$!></label></td><td><select class="requiredselect" id="' 
