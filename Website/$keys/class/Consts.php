...
class Consts
{
    ...
    const TINY_COLUMN_WIDTH = <!$TINY_COLUMN_WIDTH$!>;
    const SHORT_COLUMN_WIDTH = <!$SHORT_COLUMN_WIDTH$!>;
    const NORMAL_COLUMN_WIDTH = <!$NORMAL_COLUMN_WIDTH$!>;
    const LONG_COLUMN_WIDTH = <!$LONG_COLUMN_WIDTH$!>;
    const EXTRA_LONG_COLUMN_WIDTH = <!$EXTRA_LONG_COLUMN_WIDTH$!>;
    const GRID_COLUMN_PIXELS_PER_LETTER = <!$GRID_COLUMN_PIXELS_PER_LETTER$!>;
    ...
    */
	...
	const PERMISSION_AREA_STORAGE_AREAS = 38;
	const PERMISSION_AREA_UNITS = 11;
	const PERMISSION_AREA_UNIT_ABBREVIATION = 18;
	const PERMISSION_SCOPE_COOP = 39;
	const PERMISSION_SCOPE_GROUP = 40;
	const PERMISSION_TYPE_ADD = 48;
	const PERMISSION_TYPE_COORD = 42;
	const PERMISSION_TYPE_COORD_SET = 43;
	const PERMISSION_TYPE_COPY = 46;
	const PERMISSION_TYPE_DELETE = 45;
	const PERMISSION_TYPE_EXPORT = 47;
	const PERMISSION_TYPE_MODIFY = 41;
	const PERMISSION_TYPE_UPLOAD_FILE = 49;
	const PERMISSION_TYPE_VIEW = 44;
	const ROLE_COOP_CHIEF_COORDINATOR = 51;
	const ROLE_COOP_ORDER_COORDINATOR = 53;
	const ROLE_MEMBER = 55;
	const ROLE_MEMBERSHIP_COORDINATOR = 57;
	const ROLE_PICKUP_LOCATION_COORDINATOR = 54;
	const ROLE_PRODUCER = 56;
	const ROLE_PRODUCER_COORDINATOR = 52;
	const ROLE_SYSTEM_ADMIN = 50;
	const UNIT_GALLON = 70;
	const UNIT_GALLON_ABBRV = 71;
	const UNIT_GRAM = 64;
	const UNIT_GRAM_ABBRV = 65;
	const UNIT_ITEMS = 58;
	const UNIT_ITEMS_ABBRV = 59;
	const UNIT_KG = 60;
	const UNIT_KG_ABBRV = 61;
	const UNIT_LITER = 62;
	const UNIT_LITER_ABBRV = 63;
	const UNIT_OUNCE = 68;
	const UNIT_OUNCE_ABBRV = 69;
	const UNIT_POUND = 66;
	const UNIT_POUND_ABBRV = 67;
