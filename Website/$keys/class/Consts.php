...
class Consts
{
    ...
    */
    ...
    const PERMISSION_SCOPE_COOP = 37;
    const PERMISSION_SCOPE_GROUP = 38;
    const PERMISSION_TYPE_ADD = 46;
    const PERMISSION_TYPE_COORD = 40;
    const PERMISSION_TYPE_COORD_SET = 41;
    const PERMISSION_TYPE_COPY = 44;
    const PERMISSION_TYPE_DELETE = 43;
    const PERMISSION_TYPE_EXPORT = 45;
    const PERMISSION_TYPE_MODIFY = 39;
    const PERMISSION_TYPE_UPLOAD_FILE = 47;
    const PERMISSION_TYPE_VIEW = 42;
    const ROLE_COOP_CHIEF_COORDINATOR = 49;
    const ROLE_COOP_ORDER_COORDINATOR = 51;
    const ROLE_MEMBER = 53;
    const ROLE_PICKUP_LOCATION_COORDINATOR = 52;
    const ROLE_PRODUCER = 54;
    const ROLE_PRODUCER_COORDINATOR = 50;
    const ROLE_SYSTEM_ADMIN = 48;
    const UNIT_GALLON = 67;
    const UNIT_GALLON_ABBRV = 68;
    const UNIT_GRAM = 61;
    const UNIT_GRAM_ABBRV = 62;
    const UNIT_ITEMS = 55;
    const UNIT_ITEMS_ABBRV = 56;
    const UNIT_KG = 57;
    const UNIT_KG_ABBRV = 58;
    const UNIT_LITER = 59;
    const UNIT_LITER_ABBRV = 60;
    const UNIT_OUNCE = 65;
    const UNIT_OUNCE_ABBRV = 66;
    const UNIT_POUND = 63;
    const UNIT_POUND_ABBRV = 64;
