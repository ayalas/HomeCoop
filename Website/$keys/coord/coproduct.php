  ...
  <?php
    ...
    { ?> 
      ...
      if (ctlDisabled.options[ctlDisabled.selectedIndex].value == 1) {
        sMessage = "<?php echo sprintf('<!$ARE_YOU_SURE_DELETE_COOP_ORDER_PRODUCT_MSG$!>', $oRecord->TotalCoopOrder); ?>";
        if (!confirm(decodeXml(sMessage)))
          return;
      }
    <?php } ?>
        ...
        <td >
                ...
                <tr>
                  <?php                      
                     ...
                     HtmlTextEditMultiLang::EchoHelpText('<!$TOOLTIP_COOP_ORDER_MAX_PRODUCT_ORDER$!>', 'MaxCoopOrder');
                     HtmlTextEditMultiLang::OtherLangsEmptyCells();
                  ?>
                </tr>
                <tr>
                ...
                <?php
                  ...
                  foreach($oRecord->PickupLocationsStorage as $PickupLocationID => $Sections)
                  {
                    ...
                    HtmlTextEditMultiLang::EchoHelpText('<!$TOOLTIP_COOP_PRODUCT_PICKUP_LOCATION_STORAGE_AREA$!>', 'StorageArea_' . $PickupLocationID);
                    HtmlTextEditMultiLang::OtherLangsEmptyCells();
