...
echo '<div class="month_title">'
        , '<a title="<!$DATE_PICKER_PREV_TITLE$!>" href="';
...
echo $sUrl , '&month=' , $nmonth , '&year=' , $nyear , '" class="month_move"><!$DATE_PICKER_NEXT$!></a>' ,
        '<div class="r"></div>' ,
    '</div>';
for ($d=0;$d<7;$d++) {
