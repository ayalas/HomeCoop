...
function WritePaging() {
  ...
  if ($nPage <= 0 || $nPage > 1) {
    //back to first page
    echo '<a href="', $sLinkBase, '1', '" title="<!$PAGING_FIRST_PAGE$!>" ><img src="',
        $g_sRootRelativePath,
    ...
    if ($nPage > 1 || $bHasNextPage) {
      echo '<a href="', $sLinkBase, ($nPage -1), '" title="<!$PAGING_PREV_PAGE$!>" ><img src="',
        $g_sRootRelativePath,
  ...
  if ($g_sPageNumber != 'last' && $bHasNextPage) {
    //forward one page
    echo '<a href="', $sLinkBase, ($nPage+1), '" title="<!$PAGING_NEXT_PAGE$!>" ><img src="',
        $g_sRootRelativePath,
        'img/arrow-', $sForwardDir, '.png" border="0" /></a>';
    
    //forward to last page
    echo '<a href="', $sLinkBase, 'last', '" title="<!$PAGING_LAST_PAGE$!>" ><img src="',
      $g_sRootRelativePath,
