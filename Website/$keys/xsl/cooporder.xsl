...
<office:settings>
 ...
 <style:style style:name="memcol" style:family="table-column">
   <style:table-column-properties fo:break-before="auto" style:column-width="0.6in"/>
  </style:style>
 <style:style style:name="prdcol" style:family="table-column">
   <style:table-column-properties fo:break-before="auto" style:column-width="1.8in"/>
  </style:style> 
  <style:style style:name="dblcol" style:family="table-column">
   <style:table-column-properties fo:break-before="auto" style:column-width="1in"/>
  </style:style>
  <style:style style:name="ho1" style:family="table-row">
  ...
  <style:style style:name="ro2" style:family="table-row">
   <style:table-row-properties style:row-height="0.22in" fo:background-color="<!$COOP_ORDER_EXPORT_ROW_ALTERNATE_BG_COLOR$!>" fo:break-before="auto" style:use-optimal-row-height="false"/>
  </style:style>
...
<style:style style:name="memtitle" style:family="table-cell" style:parent-style-name="Default">
  ...
  <style:style style:name="celldata" style:family="table-cell" style:parent-style-name="Default">
   <style:table-cell-properties style:text-align-source="fix" style:repeat-content="false" />
   <style:paragraph-properties fo:text-align="center" fo:margin-left="0in">
   <xsl:if test="orientation = 'rtl' ">
    <xsl:attribute name="style:writing-mode">rl-tb</xsl:attribute>
 ...
 <style:style style:name="prddata" style:family="table-cell" style:parent-style-name="Default">
   <style:table-cell-properties style:text-align-source="fix" style:repeat-content="false" />
   <style:paragraph-properties fo:margin-left="0in">
   <xsl:if test="orientation = 'rtl' ">
    <xsl:attribute name="style:writing-mode">rl-tb</xsl:attribute>
...
<xsl:template match="colh">
  <table:table-header-columns>
   ...
   <table:table-column table:style-name="regcol" table:default-cell-style-name="celltitle"/>
   <table:table-column table:style-name="dblcol" table:default-cell-style-name="celltitle"/>
  </table:table-header-columns>
  
  <xsl:for-each select="memh">
    <table:table-column table:style-name="memcol" table:default-cell-style-name="Default"/>
  </xsl:for-each> 
  ...
  <table:table-row table:style-name="ho1">
   ...
   <table:table-cell table:style-name="celltitle" office:value-type="string">
    <text:p><xsl:value-of select="priceh"/></text:p>
   </table:table-cell>
   <table:table-cell table:style-name="celltitle" office:value-type="string">
    <text:p><xsl:value-of select="quantityh"/></text:p>
   </table:table-cell>
   <table:table-cell table:style-name="celltitle" office:value-type="string">
    <text:p><xsl:value-of select="packageh"/></text:p>
   </table:table-cell>
   
   <xsl:for-each select="memh">
   <table:table-cell table:style-name="memtitle" office:value-type="string">
    <text:p>
      <xsl:value-of select="."/>
     </text:p>
   </table:table-cell>
...
<xsl:template match="row">
  <table:table-row>
   ...
   <xsl:when test="position() mod 2 = 0">
      <xsl:attribute name="table:style-name">ro2</xsl:attribute>
   </xsl:when>
   <xsl:otherwise>
      <xsl:attribute name="table:style-name">ro1</xsl:attribute>
   </xsl:otherwise>
   </xsl:choose> 
   ...
   <table:table-cell table:style-name="prddata" office:value-type="string">
    <text:p><xsl:value-of select="package"/></text:p>
   </table:table-cell>
