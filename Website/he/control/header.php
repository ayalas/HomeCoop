...
<table cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr class="usermenu"><td class="usermenucell">
      ...
      {
        echo '<span class="usermenulabel" title="הפרופיל שלי"><a href="', $g_sRootRelativePath, 
        ...
        if ( $g_oMemberSession->CanOrder) 
        {
          ...
          if ($oPermissionBridgeSet->DefinePermissionBridge(prmidMyOrder, Consts::PERMISSION_AREA_ORDERS, Consts::PERMISSION_TYPE_MODIFY, 
            ...
            echo '<span class="usermenulabel"><a href="',$g_sRootRelativePath,
                  'orders.php">ההזמנות שלי</a></span>';
        }
        
        echo '<span class="usermenulabel"><a href="', $g_sRootRelativePath, 'catalog.php">קטלוג המוצרים</a></span>';
      }
      ...
      if ( isset($g_oMemberSession) )
      {
            ...
            echo '<span class="usermenulink usermenulabel" onclick="JavaScript:Logout()" >יציאה</span>';
      }  
      ?>
      </td>
    </tr>
