...
{
?>
<li><span class="coordmenulabel"><a href="<?php echo $g_sRootRelativePath; ?>coord/cooporders.php">הזמנות קואופרטיב</a></span></li>
<?php
}    
...
{
?>
<li><span class="coordmenulabel"><a href="<?php echo $g_sRootRelativePath; ?>orders.php">הזמנות חבר/ה</a></span></li>
<?php
}
...
{
?>
<li><span class="coordmenulabel"><a href="<?php echo $g_sRootRelativePath; ?>coord/producers.php">יצרנים</a></span></li>
<?php
}
...
{
?>
<li><span class="coordmenulabel"><a href="<?php echo $g_sRootRelativePath; ?>coord/products.php">מוצרים</a></span></li>
<?php
}
...
{
?>
<li><span class="coordmenulabel"><a href="<?php echo $g_sRootRelativePath; ?>coord/pickuplocs.php">מקומות איסוף</a></span></li>
<?php
}
...
{
?>
<li><span class="coordmenulabel"><a href="<?php echo $g_sRootRelativePath; ?>coord/cachier.php">מצב הקופה</a></span></li>
<?php
}
...
{
?>
<li><span class="coordmenulabel"><a href="<?php echo $g_sRootRelativePath; ?>coord/members.php">חברות/ים</a></span></li>
<?php
}
