...
try
{
  ...
  while ( $recTable )
  {
      ...
      //order details
       ...
       '<tr><td class="oppositealign" ><span class="normalcolor" >סגירה‏:‏</span></td><td><span ',
                $sOrderCssClass , ' >&nbsp;' , $dEnd->format('j.n.Y') , '</span><span ' , $sOrderCssClass , ' >&nbsp;' ,
             'בשעה&nbsp;' , $dEnd->format('G:i') , '</span></td></tr>',
      
       "<tr><td class='oppositealign' ><span class='normalcolor' >משלוח‏:‏",
      ...
      //producers
       '<tr>',
       '<td class="listareatitle" >יצרנים‏:‏</td>',
