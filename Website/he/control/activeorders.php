...
try
{
  ...
  while ( $recTable )
  {
      ...
      //row: closing date
      echo '<tr><td>',
        '<div class="normalcolor" >סגירה‏:‏‏&nbsp;</span><span ',
               $sOrderCssClass , ' >&nbsp;' , $dEnd->format('j.n.Y') , '</div><div ' , $sOrderCssClass , ' >&nbsp;' ,
            'בשעה&nbsp;' , $dEnd->format('G:i') , '</div>',
        '</td></tr>';
      
      //row: delivery date
      echo "<tr><td><span class='normalcolor' >משלוח‏:‏‏&nbsp;" ,
      ...
      echo '<tr><td><span class="listareatitle">איסוף:‏</span><span class="normalcolor" >';
      ...
      //row: producers
      echo '<tr><td><span class="listareatitle">יצרן:‏</span><span class="normalcolor" >';
