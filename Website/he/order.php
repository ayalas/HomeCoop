              ...
              <table cellspacing="0" cellpadding="2" width="100%">
                ...
                <?php } 
                      ...
                      $oRecord->HasPermission(Order::PERMISSION_SET_MAX_ORDER) )
                  {
                    ...
                    echo '<td><a id="percentoverhlp" name="percentoverhlp" class="tooltiphelp" href="#percentoverhlp" >‏?‏<span class="helpspan">בכמה אחוזים מהיתרה ניתן לחרוג בכל הזמנה. כלל זה מוחל רק כאשר שיטת התשלום מאפשרת אחוז חריגה</span></a></td>';
                    echo '</tr>';
