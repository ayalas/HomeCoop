...
class HtmlStorageArea {
  ...
  public function __get( $name ) {
    ...
    public function EchoHtml()
    {
      ...
      HtmlTextEditMultiLang::EchoHelpText('הקבולת המקסימאלית של מקום האחסון במונחים של שדה המוצר &quot;מעמסה&quot;. הסכום של המעמסות של כל המוצרים כפול הכמות שהוזמנה מכל מוצר יושווה לערך זה עבור כל ההזמנות של מוצרים המיועדים למקום אחסון זה. זהו רק ערך ברירת מחדל, וניתן להחליפו בהגדרות מקום האחסון של הזמנת הקואופרטיב.');
