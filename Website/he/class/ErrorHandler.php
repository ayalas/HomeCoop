...
class ErrorHandler {
  ...
  public function HandleException($e)
  {
    ...
    {
      $sErrorMessage = 'האתר עמוס כרגע. אנא נסו שוב מאוחר יותר';
      $bTransformed = TRUE;
    }
    else
    {
      $sErrorMessage = sprintf('מידע טכני:<br/><div dir="ltr">Message: %s<br/>Trace: %s</div>', 
    ...
    else
    {
      ...
      $this->AddError( 'אירעה שגיאה במערכת.<br/>' . $sErrorMessage );
    }
  }
