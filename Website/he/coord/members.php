...
<title>הזינו את שם הקואופרטיב שלכם: חברות/ים</title>
    ...
    <tr>
      <td nowrap>
        <input id="txtSearch" name="txtSearch" type="text" maxlength="100" value="<?php 
            echo htmlspecialchars($oTable->SearchPhrase); ?>"/><span class="link" onclick="JavaScript:Search();" ><img border="0" title="חיפוש" src="../img/view-refresh-8.png" /></span>&nbsp;
      </td>
      <?php
          $selList = new HtmlSelectArray('DataSet', 'נתונים ליצוא', $arrList, 0);
    ...
    <tr>
        <td colspan="4">
                <table cellspacing="0" cellpadding="2" width="100%">
                  ...
                  ?>
                  <tr>
                    <td colspan="7"><a href="member.php" ><img border="0" title="הוספה" src="../img/edit-add-2.png" /></a>
                      &nbsp;<span class="link" onclick="JavaScript:SelectAll(true);">כולם</span>&nbsp;
                ...
                else
                {
                  ...
                  while ( $recTable )
                  {
                      ...
                      if ($recTable["PaymentMethodKeyID"] == Consts::PAYMENT_METHOD_PLUS_EXTRA)
                        echo sprintf('עד ליתרה + %%%s חריגה', ($recTable["fPercentOverBalance"] + 0));
                      else 
